"""Fixtures for audit-module integration tests (TASK-080).

Mirrors the users/auth integration conftest pattern: real FastAPI app against the
Docker PostgreSQL test database with an ephemeral RS256 keypair.
"""
...
async def create_member(
    ...
    *,
    role: str = "resident",
    email: str | None = None,
    password: str = "memberPass123",
) -> tuple[uuid.UUID, str, str]:
    """Insert a tenant member directly with a base role (mirrors the users module helper)."""
