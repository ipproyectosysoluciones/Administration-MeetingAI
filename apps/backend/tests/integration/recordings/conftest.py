"""Fixtures for recordings integration tests (TASK-252/253).

Mirrors the meetings conftest pattern: real FastAPI app + migrated PostgreSQL.
"""
...
from tests.integration.meetings.conftest import (  # noqa: E402, F401
    api,
    create_member,
    register_admin,
)
