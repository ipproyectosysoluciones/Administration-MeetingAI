...
- [x] **TASK-112** `chore: GitHub Actions CI (lint, typecheck, unit, integration, build)` — per AGENTS.md §12 gates. Tests: pipeline green.
- [x] **TASK-113** `docs: README quickstart + docs/architecture notes for this change` — update README if commands changed.
